...
class Version20181107114546 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE item (id INT AUTO_INCREMENT NOT NULL, creator_id INT DEFAULT NULL, owner_id INT DEFAULT NULL, updater_id INT DEFAULT NULL, creation_date DATETIME DEFAULT NULL, update_date DATETIME DEFAULT NULL, name VARCHAR(191) NOT NULL, description TEXT NOT NULL, INDEX IDX_1F1B251E61220EA6 (creator_id), INDEX IDX_1F1B251E7E3C61F9 (owner_id), INDEX IDX_1F1B251EE37ECFB0 (updater_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE booking (id INT AUTO_INCREMENT NOT NULL, creator_id INT DEFAULT NULL, owner_id INT DEFAULT NULL, updater_id INT DEFAULT NULL, responsible_id INT DEFAULT NULL, creation_date DATETIME DEFAULT NULL, update_date DATETIME DEFAULT NULL, participant_count INT UNSIGNED DEFAULT 1 NOT NULL, destination VARCHAR(50) DEFAULT \'\' NOT NULL, start_comment TEXT NOT NULL, end_comment TEXT NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME DEFAULT NULL, estimated_end_date VARCHAR(50) DEFAULT \'\' NOT NULL, INDEX IDX_E00CEDDE61220EA6 (creator_id), INDEX IDX_E00CEDDE7E3C61F9 (owner_id), INDEX IDX_E00CEDDEE37ECFB0 (updater_id), INDEX IDX_E00CEDDE602AD315 (responsible_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tag (id INT AUTO_INCREMENT NOT NULL, creator_id INT DEFAULT NULL, owner_id INT DEFAULT NULL, updater_id INT DEFAULT NULL, creation_date DATETIME DEFAULT NULL, update_date DATETIME DEFAULT NULL, name VARCHAR(191) NOT NULL, INDEX IDX_389B78361220EA6 (creator_id), INDEX IDX_389B7837E3C61F9 (owner_id), INDEX IDX_389B783E37ECFB0 (updater_id), UNIQUE INDEX unique_name (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, creator_id INT DEFAULT NULL, owner_id INT DEFAULT NULL, updater_id INT DEFAULT NULL, responsible_id INT DEFAULT NULL, creation_date DATETIME DEFAULT NULL, update_date DATETIME DEFAULT NULL, login VARCHAR(50) NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(191) NOT NULL, role ENUM(\'member\', \'administrator\') DEFAULT \'member\' NOT NULL COMMENT \'(DC2Type:UserRole)\', active_until DATETIME DEFAULT NULL, phone VARCHAR(25) DEFAULT \'\' NOT NULL, birthday DATE DEFAULT NULL, name VARCHAR(191) NOT NULL, UNIQUE INDEX UNIQ_8D93D649AA08CB10 (login), INDEX IDX_8D93D64961220EA6 (creator_id), INDEX IDX_8D93D6497E3C61F9 (owner_id), INDEX IDX_8D93D649E37ECFB0 (updater_id), INDEX IDX_8D93D649602AD315 (responsible_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE item ADD CONSTRAINT FK_1F1B251EE37ECFB0 FOREIGN KEY (updater_id) REFERENCES user (id)');
