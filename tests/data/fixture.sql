...
REPLACE INTO product (id, is_active, image_id, file_id, price_per_unit_chf, price_per_unit_eur, code, review_number, review_id, type, release_date, name, short_description) VALUES
...
(3003, 1, NULL, NULL, 500, 450, '2019-02-01b', NULL, 3000, 'digital', NULL, 'Article numérique 2', 'Nullam id dolor id nibh ultricies vehicula ut id elit. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Donec sed odio dui. Donec ullamcorper nulla non metus auctor fringilla. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed posuere consectetur est at lobortis.'),
(3004, 1, NULL, NULL, 500, 450, '2019-02-01c', NULL, 3000, 'digital', NULL, 'Article numérique 3', 'Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Cras justo odio, dapibus ac facilisis in, egestas eget quam.'),
