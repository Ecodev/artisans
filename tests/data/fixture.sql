...
(3002, NULL, 10036, 0, 10, 0, 'Casier virtuel (3002, sur demande, periodic)', 'casier', 'admin_approved', -1, 'Pour demande de stockage.'),
(3003, NULL, 10036, 0, 10, 0, 'Casier 1012 (3003, inventaire / spécifique admin, periodic)', 'CA1012', 'admin_only', -1, 'Casier physique XYZ.'),
(3004, NULL, 10035, 0, 20, 0, 'Membre NFT (3004, inventaire / spécifique admin, periodic)', 'e', 'admin_approved', -1, 'Service supplémentaire.'),
...
(3026, NULL, 10104, 0, 10, 0, 'Fonds de réparation interne', 'COFR', 'mandatory', -1, 'Cotisation annuelle pour assurer une couverture en cas de dégâts au matériel nautique du club'),
(3027, NULL, 10036, 0, 10, 0, 'Armoire 1013 (3027, inventaire / spécifique admin, periodic)', 'A1013', 'admin_only', -1, 'Armoire physique XYZ.'),
(3028, NULL, 10036, 0, 10, 0, 'Flotteur 1014 (3028, inventaire / spécifique admin, periodic)', 'F1014', 'admin_only', -1, 'Flotteur physique XYZ.'),
(3030, NULL, 10036, 0, 10, 0, 'Armoire virtuelle (3030, sur demande, periodic)', 'armoire', 'admin_approved', -1, 'Pour demande de stockage.'),
(3031, NULL, 10036, 0, 10, 0, 'Flotteur virtuel (3031, sur demande, periodic)', 'flotteur', 'admin_approved', -1, 'Pour demande de stockage.');
